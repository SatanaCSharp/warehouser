...
Six internal lenses for Phase 2. These are lenses for _you_, not labels for the
...
Every framed question still obeys the hard rules: it uses the available user-input mechanism
...
- **Framed:** "It's six months out and you quietly dropped this. Which is the most likely cause?"
  - _(Recommended)_ You ran out of energy before it compounded — solo cadence is the real constraint
...
- **Framed:** "Say it takes off and doubles your inbound. What's the first thing that buckles?"
  - _(Recommended)_ Your calendar — you can't service the demand you create
...
- **Framed:** "A sharp person outside your bubble hears the one-liner. What do they misread first?"
  - _(Recommended)_ They think it's for beginners when you mean seniors
  - They can't tell what they'd _do_ differently after consuming it
...
- **Framed:** "Instead of long-and-thorough, what if it were short-and-frequent?"
  - _(Recommended)_ Short-and-frequent — momentum matters more than depth here
...
- **Framed:** "If you started this in three months instead of now, what's actually lost?"
  - _(Recommended)_ Nothing structural — so de-risk first, start smaller
...
- **Framed:** "Your most skeptical teammate is in the room. Which objection do they raise first?"
  - _(Recommended)_ "We tried this and it died" — there's prior history you're discounting
