...
- **Approved design fidelity (for a UI surface).** Read `design-handoff.md` and compare the implementation at its recorded viewports/states with the approved Pencil frame and preview evidence. Flag meaningful layout, hierarchy, token, interaction, responsive, or accessibility drift unless it is listed under Approved deviations. Do not demand DOM/code similarity to generated output.
