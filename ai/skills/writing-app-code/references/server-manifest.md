...
| A new cross-module dependency, or a decision about which module owns behavior                     | ADR `18-08-2026-scope-of-exercise-placement-tiebreak.md` (ADR `14-08-2026` for the reasoning); `sad.md`   |
...
| A guard, a Permission declaration, `@ObservedPermission`, `shared/guards/`, `shared/access/`      | `guides/server-request-authorization.md`                                                                  |
