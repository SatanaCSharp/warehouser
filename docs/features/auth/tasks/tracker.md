...
| T9  | [Expose and wire the auth REST boundary](./expose-auth-rest.md)                               | ports     | Backend Lead                  | M        | T2, T6, T7, T8    | todo   |
| T10 | [Build the credentialed web API and feedback boundary](./build-web-auth-boundary.md)          | infra     | Frontend Lead                 | M        | T2                | todo   |
