...
| T6  | [Build the customers domain: value objects, predicates, error factories, mappers and CustomerAddressBookService](./customers-domain.md)                                                    | `domain`    | Backend Lead  | M        | T4, T7        | todo   |
