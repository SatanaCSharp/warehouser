...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- | ------------- | -------- | ------------- | ------ |
| T1  | [Promote the customer-schema migration: two relations, their checks, keys and the partial unique Main-address index](./create-customer-schema-migration.md)                                | `migration` | Backend Lead  | S        | —             | todo   |
| T2  | [Promote the delivery-destinations migration: 14 columns across five shipped relations, with the Via Warehouse and ending-attribution backfills](./add-delivery-destinations-migration.md) | `migration` | Backend Lead  | L        | T1            | todo   |
| T3  | [Promote the Permission grant migration and add the feature's PermissionId, WorkspacePermissionId and ErrorCode members](./grant-delivery-address-permissions-migration.md)                | `migration` | Backend Lead  | S        | T2            | todo   |
