...
| T16 | [Expose the purchase-drafts REST surface: contracts subpath, transition sub-resources, controllers and module wiring](./purchase-drafts-rest-surface.md)                        | `ports`     | Backend Lead  | L        | T14, T15, T4   | done        |
...
| T22 | [Add the ordering load smoke and the structured timing assertions for the section 6 latency targets](./ordering-performance-gate.md)                                            | `tests`     | Tech Lead     | S        | T7, T11, T16   | in_progress |
