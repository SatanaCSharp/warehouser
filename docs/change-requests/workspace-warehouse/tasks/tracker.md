...
**Total:** 15 tasks, ~10 person-days. T15 is partially complete: the ten entry-latency
figures are recorded and pass, the four 390px responsive checks still need a person at a real
narrow viewport — see [the task record](./responsive-and-entry-latency-verification.md).
