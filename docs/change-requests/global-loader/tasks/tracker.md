...
| --- | ------------------------------------------------------------- | ------ | ------ | -------- | -------------------------------- | ----------- |
| T1  | Declare the pending and error contract on the three routes    | wiring | YuriiH | M        | —                                | done        |
...
| T10 | Delete the two skeletons and the Warehouses-side branches     | ui     | YuriiH | M        | T7                               | in_progress |
| T11 | Drop the four Workspace-administration tab readiness arms     | ui     | YuriiH | S        | T7                               | in_progress |
