...
| CH-D2 | `docs/system/adr/18-08-2026-workspace-scoped-administration-placement.md` | Absent                                                                                                                                                            | ADD       | Accepted ADR stating the scope-placement rule **and** answering both the §3.1.1 asymmetry and ADR 14-08's "organize by consumer" rejection                                     | Doc-only      | CR-AC-03               |
...
| `docs/system/adr/18-08-2026-workspace-scoped-administration-placement.md` | Created `Accepted`, with the §3.1.1 rule and an answer to ADR 14-08's objection | same                                                           |
