...
| -------------------- | -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Bundle: eager chunks | Lazy route boundaries per module | Unchanged — no new eager chunk                                                                                                            | `pnpm --filter @warehouser/web build` at `baseline_revision` and `HEAD`; the normalized, hash-stripped, path-rewritten module→chunk manifest diffs empty apart from the five enumerated CH-W5 components, each held to its parent component's chunk; chunk keys and `isEntry`/`isDynamicEntry` identical to baseline (CR-RG-05) |
