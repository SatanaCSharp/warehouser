...
| T13 | [Assert case-count identity — the 39 baseline cases, none lost](./t13-assert-case-count-identity.md) | tests | T11, T12       | Union contains the baseline's 39 names; exact per-file distribution, 27/7/4/4 at `HEAD`                   |
