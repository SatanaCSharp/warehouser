...
import { WorkspaceRoleEditor } from 'modules/workspace/components/workspace-administration/roles/WorkspaceRoleEditor';
import { WorkspaceRoleList } from 'modules/workspace/components/workspace-administration/roles/WorkspaceRoleList';
