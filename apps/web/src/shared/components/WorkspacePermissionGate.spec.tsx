...
describe('WorkspacePermissionGate', () => {
  ...
  it('renders nothing while the cache resolves', () => {
    vi.stubGlobal(
      'fetch',
      vi.fn(() => new Promise(() => {})),
    );
...
describe('WorkspacePermissionGateProps / PermissionId vocabulary separation (AC-31)', () => {
  it('never accepts the Warehouse-level PermissionId as the gate permission prop', () => {
    type GatePermissionProp = WorkspacePermissionGateProps['permission'];
